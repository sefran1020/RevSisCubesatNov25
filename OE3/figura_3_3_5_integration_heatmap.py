...
plt.savefig('G:/RevSisOrd/OE3Figuras/Figure_3_3_5_Integration_Heatmap.png', dpi=300, bbox_inches='tight')
plt.savefig('G:/RevSisOrd/OE3Figuras/Figure_3_3_5_Integration_Heatmap.pdf', bbox_inches='tight')

print("[OK] Figura 3.3.5 generada exitosamente")
